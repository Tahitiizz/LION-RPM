...
include_once(REP_PHYSIQUE_NIVEAU_0 . "parser/$module/scripts/ParserHuaweiLTE.class.php");
include_once(REP_PHYSIQUE_NIVEAU_0 . "parser/$module/scripts/XMLConditionProvider.class.php");


$parsersType= array(LoadData::KEY_PARSER => "ParserHuaweiLTE");
