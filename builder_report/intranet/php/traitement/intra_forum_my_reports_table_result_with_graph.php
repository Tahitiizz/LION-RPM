...
$tableau_abscisse_export_excel[$tableau_resultat->tableau_number] = array_shift($tableau_data_export_excel[$tableau_resultat->tableau_number]);
...
// la génération du graphe a besoin d'éléments produits par la génération du tableau
// c'est pourquoi, on charge la page du graphe une fois que celle du tableau est traitée
?>
          <script>
          parent.result_graph.location="../affichage/intra_forum_my_reports_graph_result.php?display=1&id_query=<?=$id_query?>&nombre_donnees_graphe=<?=$nombre_champ?>&product=<?=$product?>";
          </script>
      </td>
    </tr>
  </table>
