...
$chessPlayers = array('M','i','k','e', 'S','m','i','t','h', 'J','i','m','M','o','r','g','a','n', 'J',
					  'o','c','h','g','a','n','B','e','r','g', 'B','i','l','l','S','c','o','t','t', 'Bill Martines', 'John Po', 'Aleck Harrison', 'Ann Scott', 'Johnatan Fredericson', 'Eva Carter');
