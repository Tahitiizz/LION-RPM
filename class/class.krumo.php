...
*
* @package Krumo
* @version $Id: class.krumo.php 63556 2012-02-06 17:07:49Z o.jousset $
*/
...
<?php
	...
	*/
	function _css() {
		...
		if (!$css && ($skin != 'default')) {
			$skin = 'default';
			// modif 25/06/2007 Gwénaël
				//modif du chemin
			$_ = KRUMO_DIR . "../css/krumo/default/skin.css";
			$css = join('', @file($_));
			}
		...
		if ($_css = $css != '') {
			...
			global $niveau0;
			$css_url = ProductModel::getCompleteUrlForMasterGui();
			$css_url .= krumo::_config('css', 'url') . "{$skin}/";
...
<!--//
<?php echo join('', file(KRUMO_DIR . "../js/krumo.js")); ?>
