...
archive="ta_erilte_5.3.3.02.tar.gz"
parser_name="erilte"
default_appname="astellia_ericsson_lte"
product_name="erilte"
product_label="Ericsson LTE"
product_version="5.3.3.02"
pkgmd5="af0694195659519da6b6ab20c254c8f5"
type_install="installation"
install_order="cb_base;parser;context"
gen_inst_version="3.17" # 11/02/2011 11:05 SCT : ajout de la version du gen_inst utilisé pour faire le package produit dans le fichier de log
...
[ -d $WORKING_DIR/context ] && MSG="$MSG\nThe final version of Context will be: $ctx_ver" && MSG="$MSG\nNotice that the services Postgresql and Apache will be reloaded during the installation.\nCheck that all services (Cron) of the others applications T&A are stopped before continue this installation."
cat $MSG
show_msg "$MSG" "$TITLE"
