...
*
*	19/01/2010 NSE : définition de la vérification sur le commentaire (bz 13799)
...
<?php
    ...
    define("FP_DEFAULT_GLOBAL_FORM_ERR_MSG", 'Please, correct the marked mistakes!');
	...
	$element_title = strip_tags($element_title);

    $GLOBALS['FP_ERR_MSG'] = array(
       FP_ERR_CODE__REQ_FIELD_IS_EMPTY => 'Please, fill in the &quot;[element_title]&quot; field',
       ...
       FP_ERR_CODE__JS_REQ_FIELD_IS_EMPTY => 'Please, fill in the '.strip_tags('[element_title]').' field',
       FP_ERR_CODE__JS_FIELD_IS_INVALID => '[element_title] field value you entered is not valid',
	...
	// 19/01/2010 NSE : champ commentaire des raws
    // 14/09/2010 NSE bz 17825 : on interdit le retour à la ligne
	define("FP_VALID_COMMENT", '/^[\w](]|[\w\. \t\-\$\!\?\,\'\(\)\:\;\/\&\@\#\%\\\\0-9 _\.\+\*\[\{\}\=\<\>\-])*$/');
    ...
    define("FP_VALID_COLOR", '/^#[0-9]{3,6}$/');
    define("FP_VALID_DATE", '/^[0-9]{4}-[0-1][0-9]-[0-3][0-9]$/');
