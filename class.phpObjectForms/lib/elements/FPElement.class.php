...
<?php
    ...
    class FPElement {
		...
		var $_form_name; // Form name
        var $_cssStyle;  // used for <input ... style="$_cssStyle" ...>
        var $_cssClass;  // used for <input ... style="$_cssStyle" ...>
        ...
        {
			//__debug($params,"param elements ".$params["name"]."");
			...
			if (isset($params["wasSubmitted"]))
				$this->_wasSubmitted = $params["wasSubmitted"];
            ...
            if (isset($params["css_class"])) $this->_cssClass = $params["css_class"];
        ...
        function &getParentFormObj()
        {
			...
			// $yep = $this->_parentFormObj->_owner;
