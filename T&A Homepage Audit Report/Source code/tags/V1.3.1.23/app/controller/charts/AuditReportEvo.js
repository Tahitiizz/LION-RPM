Ext.define('homepage.controller.charts.AuditReportEvo', {
	extend : 'Ext.app.Controller',

	views : ['charts.AuditReportEvo'],
	...
	init : function() {
		...
		this.control({
					...
					'button[action=generateAuditReportEvo]' : {
						click : this.load
					}
				});
	...
	load : function(config) {
		...
		**/
		...
		var auditreportSgEvo = Ext.getCmp(tabId + '_summary_graph_evo');
		...
		if (time != undefined) {
			...
			//load summary graph
			auditreportSgEvo.fireEvent('load', config, time);
