Ext.define('homepage.view.charts.AuditReportEvo' ,{
    extend: 'Ext.panel.Panel',
    alias : 'widget.auditreportevo',
    requires: ['Ext.*'],
	layout: 'anchor',
	autoScroll: true,
    ...
    initComponent: function() {
		...
		{
			id:this.id + '_summary_graph_evo',
			xtype: 'summarygraphevo',
			iconCls: 'icoGraph',
			anchor: '98% none',
			//height: 600,
			cls: 'periodChart',
