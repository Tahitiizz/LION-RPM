...
Ext.define('Ext.ux.chart.SmartLegend', {
    ...
    create: function() {
        ...
        if(me.clickable==undefined)me.clickable=false;
    ...
    getMaximumBBox: function() {
        ...
        //YBT Change done for the legend to be able to display more than 20 elements
        return { width: chartWidth-300, height: chartHeight };
    },
