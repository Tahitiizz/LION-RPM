 ...
 * 
 * My Homepage / JGU2 : "getNaFromFamily" retournant également les labels des niveaux réseaux.
 */
class NaModelBis
{
    	/**
   ...
   */
	...
	* 22/03/2012 AVZ
	* Merge entre trunk et version My Homepage
	...
	*******/
	public static function getNaFromFamily($family,$product,$axe=1)
	{
		...
		while($array = $database->getQueryResults($result,1)) {
			$naArray[] = array("agregation" => $array['agregation'], "agregation_label" => $array['agregation_label']);
		}
		// Retour du tableau
		return $naArray;
	}
