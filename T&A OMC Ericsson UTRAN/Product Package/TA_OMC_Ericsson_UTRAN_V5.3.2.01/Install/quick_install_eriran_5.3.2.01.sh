...
archive="ta_eriran_5.3.2.01.tar.gz"
parser_name="eriran"
default_appname="astellia_ericsson_utran"
product_name="eriran"
product_label="Ericsson UTRAN"
product_version="5.3.2.01"
pkgmd5="d99fb2ea743ea2ef8b7ba306a456203a"
...
min_previous_product_version="5.1.1.04" # version minimale requise pour installation, optionnel
