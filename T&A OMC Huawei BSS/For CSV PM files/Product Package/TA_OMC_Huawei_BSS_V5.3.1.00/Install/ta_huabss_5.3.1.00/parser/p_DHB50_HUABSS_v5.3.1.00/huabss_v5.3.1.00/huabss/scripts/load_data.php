...
include_once(REP_PHYSIQUE_NIVEAU_0 . "parser/$module/scripts/ParserHuaBss.class.php");
...
$parsersType= array(LoadData::KEY_PARSER => "ParserHuaBss");
$load_data = new LoadDataHuaBss($parsersType);
$load_data->launch();
