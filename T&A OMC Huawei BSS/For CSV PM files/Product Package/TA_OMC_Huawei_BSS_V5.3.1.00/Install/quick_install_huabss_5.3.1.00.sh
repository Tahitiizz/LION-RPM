...
archive="ta_huabss_5.3.1.00.tar.gz"
parser_name="huabss"
default_appname="astellia_huawei_bss"
product_name="huabss"
product_label="Huawei BSS"
product_version="5.3.1.00"
pkgmd5="1e85fb1e5568070679898c77271201c6"
type_install="installation"
install_order="cb_base;parser;context"
gen_inst_version="3.11" # 11/02/2011 11:05 SCT : ajout de la version du gen_inst utilisé pour faire le package produit dans le fichier de log
