...
archive="ta_huabss_5.3.2.01.tar.gz"
parser_name="huabss"
default_appname="astellia_huawei_bss"
product_name="huabss"
product_label="Huawei BSS"
product_version="5.3.2.01"
pkgmd5="94dd5576cf836913a60af9beded37f44"
type_install="installation"
install_order="cb_base;parser;context"
gen_inst_version="3.15" # 11/02/2011 11:05 SCT : ajout de la version du gen_inst utilisé pour faire le package produit dans le fichier de log
min_previous_product_version="5.1.0.11" # version minimale requise pour installation, optionnel
