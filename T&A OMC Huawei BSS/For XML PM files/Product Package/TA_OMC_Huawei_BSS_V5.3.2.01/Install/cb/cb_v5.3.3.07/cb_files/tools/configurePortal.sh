...
auth_mode="$2"
cas_ip_address="$3"
echo "Appli_url: '$1', Appli_name: '$APPNAME', Protocol; '$ta_launch_protocol', Mode: '$auth_mode', IP: '$cas_ip_address', Log: '$LOGARG', SILENCE: '$SILENCE'"

log_milestone "command line arguments: appli_ip: '$1', Protocol; '$ta_launch_protocol', Mode: '$auth_mode', IP: '$cas_ip_address', Log: '$LOGARG', SILENCE: '$SILENCE'"
