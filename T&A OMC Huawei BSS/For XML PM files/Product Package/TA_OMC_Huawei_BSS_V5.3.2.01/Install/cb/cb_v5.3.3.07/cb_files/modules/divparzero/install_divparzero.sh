...
if [ -d $rep_install'/modules/divparzero/lib/' ] ; then
	...
	$psql_bin -U postgres $database -p $postgresqlPort -f $rep_install'/modules/divparzero/lib/uninstall_divparzero.sql'
	$psql_bin -U postgres $database -p $postgresqlPort -f $rep_install'/modules/divparzero/lib/divparzero.sql'
else
