...
function showColor(val) {
	eval("window.opener.document.<?=$form_name?>.<?=$field_name?>.style.backgroundColor = val");
	eval("window.opener.document.<?=$form_name?>.<?=$hidden_field_name?>.value = val");
	window.close();
}
self.focus();
</script>
...
<area shape="rect" coords="289,1,297,10" href="javascript:showColor('#dddddd')">
<area shape="rect" coords="289,12,297,21" href="javascript:showColor('#bbbbbb')">
<area shape="rect" coords="289,23,297,32" href="javascript:showColor('#999999')">
<area shape="rect" coords="289,34,297,43" href="javascript:showColor('#777777')">
<area shape="rect" coords="289,45,297,54" href="javascript:showColor('#555555')">
<area shape="rect" coords="289,56,297,65" href="javascript:showColor('#333333')">
</map>
